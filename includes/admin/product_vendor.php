<?php
/**
 * Renders the export template fields for the product vendor.
 *
        ...
        <div class="options_group">
            <div class="form-field discount_type_field">
                <p class="form-field discount_type_field ">
                    <label><?php esc_html_e( 'Product Vendor fields', 'woocommerce-exporter' ); ?></label>
                </p>
                <?php if ( ! empty( $fields ) ) { ?>
                ...
                <?php } else { ?>
                    <p><?php esc_html_e( 'No Product Vendor fields were found.', 'woocommerce-exporter' ); ?></p>
                <?php } ?>
            </div>
            <!-- .form-field -->
        </div>
