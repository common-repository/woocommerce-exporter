...
class Marketing extends Abstract_Class {
    ...
    public function wcse_license_settings_page() {
        ...
        require_once WOO_CE_VIEWS_PATH . 'licenses/view-license-settings-page.php';
    }
    ...
    public function load_wcse_license_settings_page_content() {
        ...
        if ( empty( $tab ) || 'store-exporter' === $tab ) {
            include_once WOO_CE_VIEWS_PATH . 'licenses/view-license-settings-store-exporter-page.php';
        }
    }
