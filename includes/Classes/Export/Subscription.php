...
/**
 * Subscription export type class.
 *
 * @since 2.7.3
 */
class Subscription extends Abstract_Class {
     ...
     * @var string
     */
    protected $export_type = 'subscription';
    ...
    public function get_default_fields( $post_id = 0 ) {
        return woo_ce_get_subscription_fields( 'full', $post_id );
    }
    ...
    public function get_object_ids( $export ) {
        $object_ids = woo_ce_get_subscriptions( $export->args, $export );
    ...
    public function get_dataset( $object_ids, $export = null ) {
        ...
        foreach ( $object_ids as $object_id ) {
            $dataset[] = woo_ce_get_subscription_data( $object_id, $export->args, $column_keys, $export );
        }
