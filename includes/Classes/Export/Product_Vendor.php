...
/**
 * Product_Vendor export type class.
 *
 * @since 2.7.3
 */
class Product_Vendor extends Abstract_Class {
     ...
     * @var string
     */
    private $export_type = 'product_vendor';
    ...
    public function get_default_fields( $post_id = 0 ) {
        return woo_ce_get_product_vendor_fields( 'full', $post_id );
    }
    ...
    public function get_object_ids( $export ) {
        $object_ids = woo_ce_get_product_vendors( $export->args, 'term_id', $export );
    ...
    public function get_dataset( $object_ids, $export = null ) {
        ...
        foreach ( $object_ids as $object_id ) {
            $dataset[] = woo_ce_get_product_vendor_data( $object_id, $export->args, $export );
        }
