...
/**
 * Shipping_Class export type class.
 *
 * @since 2.7.3
 */
class Shipping_Class extends Abstract_Class {
     ...
     * @var string
     */
    protected $export_type = 'shipping_class';
    ...
    public function get_default_fields( $post_id = 0 ) {
        return woo_ce_get_shipping_class_fields( 'full', $post_id );
    }
    ...
    public function get_object_ids( $export ) {
        $object_ids = woo_ce_get_shipping_classes( $export->args );
    ...
    public function get_dataset( $object_ids, $export = null ) {
        $dataset = woo_ce_get_shipping_classes( $export->args, $export );
