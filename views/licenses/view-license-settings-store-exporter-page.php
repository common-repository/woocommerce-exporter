...
<div class="row">
    <div class="col-left">
        ...
        <a href="https://visser.com.au/plugins/woocommerce-export/?utm_source=wse&utm_medium=license&utm_campaign=upgradelicensebutton" target="_blank" class="button button-orange button-hero mb-1"><?php esc_html_e( 'Get Store Exporter Deluxe and Unlock All Features', 'woocommerce-exporter' ); ?></a>
        <div class="learn-more">
            <a href="https://visser.com.au/plugins/woocommerce-export/?utm_source=wse&utm_medium=license&utm_campaign=learnmorelicenselink" target="_blank" ><?php esc_html_e( 'Learn more about Deluxe features', 'woocommerce-exporter' ); ?></a>
        </div>
    </div>
    <div class="col-right demo-image">
        <a href="<?php echo esc_attr( plugins_url( '/images/store-exporter-demo.png', WOO_CE_RELPATH ) ); ?>" data-lightbox="store-exporter-demo">
            <img class="img-responsive" src="<?php echo esc_attr( plugins_url( '/images/store-exporter-demo.png', WOO_CE_RELPATH ) ); ?>" alt="<?php esc_attr_e( 'Store exporter deluxe demo', 'woocommerce-exporter' ); ?>">
        </a>
    </div>
</div>
